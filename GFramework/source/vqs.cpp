...
namespace cs350
{
    VQS::VQS( vec3 &trans, quat &rot, float s ) : translation_(trans), rotation_(rot), scale_(s)
    {}

    VQS::VQS()
    {}

    void VQS::ToMatrix( mat4& mat )
    {
    ...
    void VQS::Interpolate( const VQS &v1, const VQS &v2, float t )
    {
